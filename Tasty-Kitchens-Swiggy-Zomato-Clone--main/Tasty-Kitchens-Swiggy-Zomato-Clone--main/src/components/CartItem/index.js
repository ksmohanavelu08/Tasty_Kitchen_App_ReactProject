...
class CartItem extends Component {
  ...
  render() {
    ...
    return (
      <>
        <li data-testid="cartItem" className="mobile-list-cart-item">
          <img
        ...
        <li data-testid="cartItem" className="desktop-list-cart-item">
          ...
          <p data-testid="total-price" className="desktop-cart-item-cost">
            <span>₹ </span>
            {totalItemCost}
          </p>
        </li>
